...
namespace Barbon\HostedApi\Agent\ReferenceBundle\Controller\Cases;
...
/**
 * @Route("/view", service="barbon.hosted_api.agent.reference.controller.cases.view_controller")
 */
