<?php
/**
* Class definition for the form elements in the subform Parnership
* @author John Burrin
* @since 1.5
*/
class LettingAgents_Form_Subforms_Partnership extends Zend_Form_SubForm
{
   /**
     * 
     *
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'contact_name', array(
            ...
            'validators' => array(
                array(
                    'NotEmpty', true, array(
                        'messages' => array(
                            'isEmpty' => 'Partners name is required',
        ...
        $this->setDecorators(array(
            array('ViewScript', array('viewScript' => 'subforms/partnership.phtml'))
        ));
