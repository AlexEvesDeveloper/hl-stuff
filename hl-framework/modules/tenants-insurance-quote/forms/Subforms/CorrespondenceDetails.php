...
class TenantsInsuranceQuote_Form_Subforms_CorrespondenceDetails extends Zend_Form_SubForm
{
    /**
    ...
    public function isValid($formData = array()) {
        ...
        if (isset($formData['cor_same_address']) && $formData['cor_same_address'] == 'yes') {
            ...
            $formData['cor_address_line1'] = $formData['ins_address_line1'];
            $formData['cor_address_line2'] = $formData['ins_address_line2'];
            $formData['cor_address_line3'] = $formData['ins_address_line3'];
            $formData['cor_address_postcode'] = $formData['ins_address_postcode'];
