...
class TenantsInsuranceQuote_JsonController extends Zend_Controller_Action
{
    ...
    public function validatePageAction() {
        ...
        switch($page) {
            case '1':
                $ajaxForm = new TenantsInsuranceQuote_Form_Step1();

                if (isset($postData['ins_postcode']) && $postData['ins_postcode'] != '') {
                    /*
                        Display Minimum Security Protection wording on step1 page
                ...
                break;
            case '2':
                $ajaxForm = new TenantsInsuranceQuote_Form_Step2();
                ...
                break;
            case '3':
                $ajaxForm = new TenantsInsuranceQuote_Form_Step3();
                ...
                break;
            case '4':
                $ajaxForm = new TenantsInsuranceQuote_Form_Step4();
