...
class LandlordsInsuranceQuote_Form_Subforms_PersonalDetails extends Zend_Form_SubForm
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'first_name', array(
            ...
            'attribs' => array(
                'onclick' => '_gaq.push([\'_trackEvent\', \'Landlord Insurance\', \'firstname\', \'Quote Form\']);',
                'data-ctfilter' => 'yes',
                'data-required' => 'required',
                'data-validate' => 'validate',
                'data-type' => 'name',
        ...
        //$this->getElement('phone_number')->addValidator(new Application_Validate_TelephoneNumber());
