...
class Connect_Form_ReferencingOvernightReport extends Zend_Form
{
    public function init()
    {
        ...
        $this->addElement('submit', 'overnight_producereport', array('label' => 'Produce Report'));
        //$this->addElement('submit', 'slareport_exporttoexcel', array('label' => 'Export to Excel'));
        
        // Set custom subform decorator
        $this->setDecorators(array(
            array('ViewScript', array('viewScript' => 'subforms/referencingovernightreport.phtml'))
        ));
        ...
        $this->getElement('overnight_producereport')->setDecorators(array(
            array('ViewHelper', array('escape' => false))
        ));
