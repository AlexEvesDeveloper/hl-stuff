<?php
class Connect_Form_Subforms_Insurance_RiskAddress extends Zend_Form_SubForm {
	public function init(){
		// Add house number/name element
		$this->addElement('text', 'ins_house_number_name', array(
		...
		$this->setDecorators(array(
				array('ViewScript', array('viewScript' => 'insurance/subforms/quote-my-riskaddress.phtml'))
		));
		...
		$view->headScript()->appendFile(
				'/assets/connect/js/addressLookup.js',
				'text/javascript'
		);
	}
