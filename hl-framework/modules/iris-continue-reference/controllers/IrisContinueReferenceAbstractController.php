 ...
 */
abstract class IrisContinueReferenceAbstractController extends Zend_Controller_Action {
...
//        // As some templates are borrowed from Connect, look there too
        ...
        if ('submit' != $actionName) {
            ...
            $this->authSession = new Zend_Session_Namespace('homelet_continuereference');
...
//            $this->_auth->setStorage(new Zend_Auth_Storage_Session('hl_continuereference'));
            ...
            if (!$exception && 200 == $response->getStatusCode()) {
                ...
                // Show error template
                $this->renderTwigView('/iris-continue-reference/error.html.twig', array(
                    'bodyTitle' => 'Error',
