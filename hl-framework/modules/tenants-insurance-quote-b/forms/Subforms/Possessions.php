...
class TenantsInsuranceQuoteB_Form_Subforms_Possessions extends Zend_Form_SubForm
{
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'possession_value', array(
            ...
            'validators' => array(
                ...
                array(
                    'regex', true, array(
                        'pattern' => '/^\d+\.?\d{0,2}$/',
                        'messages' => 'Amount of possession value must be a valid currency number'
                    )
                ),
                array(
        ...
        $view->headScript()->appendFile(
            '/assets/tenants-insurance-quote-b/js/possessions.js',
            'text/javascript'
        );
    }
