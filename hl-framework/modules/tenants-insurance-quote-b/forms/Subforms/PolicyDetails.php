...
class TenantsInsuranceQuoteB_Form_Subforms_PolicyDetails extends Zend_Form_SubForm
{
    /**
    ...
    public function init()
    {
        ...
        $view->headLink()->appendStylesheet(
            '/assets/cms/css/bootstrap-datepicker.css',
            'screen'
        );
        ...
        $view->headScript()->appendFile(
            ...
            '/assets/cms/js/bootstrap-datepicker.js',
            'text/javascript'
        )->appendFile(
            '/assets/tenants-insurance-quote-b/js/policyStartDatePicker.js',
            'text/javascript'
        );
    }
