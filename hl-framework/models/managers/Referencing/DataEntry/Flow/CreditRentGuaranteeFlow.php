...
/**
 * Advises which data entry flow item to display for a credit rent guarantee reference.
 */
class Manager_Referencing_DataEntry_Flow_CreditRentGuaranteeFlow extends Manager_Referencing_DataEntry_Flow_FlowManager {
