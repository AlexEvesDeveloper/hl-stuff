...
/**
 * Advises which data entry flow item to display for a full rent guarantee reference.
 */
class Manager_Referencing_DataEntry_Flow_FullRentGuaranteeFlow extends Manager_Referencing_DataEntry_Flow_FlowManager {
